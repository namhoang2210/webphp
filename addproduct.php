        ...
        <div class="w-4/5 ml-10">
            ...
            <div class="mt-10 ">
                <?php
                    $id = $_GET['id'];
                ?>
                <form action="addproduct_submit.php?id=<?php echo $id ?>" method="POST" enctype="multipart/form-data">
                    <label class="text-xl text-gray-600" for="">Tên sản phẩm</label> <br>
                    <input type="text" name="product_name" class=" border border-blue-400 w-96 h-10 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Nhập tên sản phẩm"> <br> 
                    <label class="text-xl text-gray-600" for="">Mô tả</label> <br> 
                    <input type="text" name="product_desc" class=" border border-blue-400 w-96 h-10 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Nhập mô tả"> 
                    <br>
                    <label class="text-xl text-gray-600" for="">Giá</label> <br> 
                    <input type="text" name="product_price" class=" border border-blue-400 w-96 h-10 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Nhập giá vnd"> 
                    <br>
                    <label class="text-xl text-gray-600" for="">Số lượng</label> <br> 
                    <input type="text" name="product_nums" class=" border border-blue-400 w-96 h-10 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Nhập số lượng"> 
                    <br>
