    ...
    <div class="flex">
        ...
        <div class="w-4/5 ml-10">
            ...
            <div class="flex justify-between mt-14 items-center">
                ...
                <button class="flex gap-2 items-center px-2 mr-8  text-xl bg-yellow-400 rounded-md py-2 text-gray-50 hover:bg-yellow-500" onclick="location.href='addcategory.php'">
                    <div class="ml-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="mt-10">
                <table class="border-t-4 border-blue-400 w-4/5 mx-auto">
                    ...
                    <tbody>
                        <?php
                            $sql_category_table = mysqli_query($con,"SELECT * FROM tbl_category ORDER BY category_id DESC ");
                            $i=0;
                            while( $row_category_table = mysqli_fetch_array($sql_category_table)){
                                $i=$i +1;
                        ?>
                        <tr>
                            ...
                            <td class=" border border-blue-100 px-2">
                                <a href="deletecategory_submit.php?id=<?php echo $row_category_table['category_id'] ?>">
